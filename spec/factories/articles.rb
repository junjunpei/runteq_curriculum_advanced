...
FactoryBot.define do
  ...
  trait :with_author do
    transient do
      sequence(:author_name) { |n| "author_name_#{n}" }
      sequence(:tag_slug) { |n| "author_slug_#{n}" }
    end
  ...
  trait :with_tag do
    transient do
      sequence(:tag_name) { |n| "tag_name_#{n}" }
      sequence(:tag_slug) { |n| "tag_slug_#{n}" }
    end
  ...
  trait :with_sentence do
    transient do
      sequence(:sentence_body) { |n| "sentence_body_#{n}" }
    end
